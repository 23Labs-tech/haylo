...
For clean Markdown of any page, append .md to the page URL. For a complete documentation index, see https://docs.vapi.ai/llms.txt. For full documentation content, see https://docs.vapi.ai/llms-full.txt.
